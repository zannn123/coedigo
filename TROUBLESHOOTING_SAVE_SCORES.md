# Troubleshooting: "Failed to Save Scores" Error
...
- **Error**: "Add at least one quiz, exam, or project."
- **Solution**: Click "Assessments" button and add at least one assessment
...
#### Orphaned Records
- **Symptom**: "Enrollment not found" or similar
- **Solution**: Contact admin to check database integrity

#### Concurrent Edits
- **Symptom**: Conflicting changes
...
- `403`: Unauthorized (not your class)
