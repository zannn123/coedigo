...
PHRASE_NORMALIZATIONS = [
    ...
    ("visual report", "graph report"),
    ("data viz", "graph"),
    ("data visualization", "graph"),
    ("bar graph", "graph"),
    ("line graph", "graph"),
    ("pie graph", "graph"),
    ("draw a graph", "create graph"),
    ("draw graph", "create graph"),
    ("make visualization", "create graph"),
    ("turn this into a graph", "create graph"),
    ("students below target", "students low performance"),
    ("below target students", "low performance students"),
]
...
INTENT_EXAMPLES = {
    ...
    "faculty_subject_students": _expand([
        ...
        "my handled subjects",
        "handled subjects and students",
        "show my class list",
        "show my handled classes",
        "who is enrolled in my classes",
    ]),
    ...
    "student_grade_graph": _expand([
        "create graph for zann",
        "create a graph for a student",
        "create graph for this student",
        "graph for student name",
        "graph for zann in cpe 316",
        "chart for zann",
        "make a student graph",
        "graph student performance",
        "student grade graph",
        "plot student grades",
        "make chart for student",
        "show performance graph for student",
        "visualize student score",
        "visualize student grades",
        "draw student grade chart",
        "show me a graph of the student",
        "turn student grades into a graph",
        "student visual report",
        "student progress graph",
        "student score chart",
    ]),
    "student_attendance_graph": _expand([
        "student attendance graph",
        "graph attendance for student",
        "show attendance chart for student",
        "plot student attendance",
        "draw attendance graph for student",
        "student attendance visual",
        "attendance chart for zann",
        "visualize zann attendance",
    ]),
    "class_performance_graph": _expand([
        "create graph for example",
        "create class performance graph",
        "create a graph",
        "make a graph",
        "show me a graph",
        "create a chart",
        ...
        "show chart of class performance",
        "plot class averages",
        "visualize class grades",
        "which subject has low grades graph",
        "show subject performance graph",
        "graph subjects below target",
        "below target graph",
        "low performance graph",
        "class visual report",
        "turn class performance into a graph",
    ]),
    "class_attendance_graph": _expand([
        "class attendance graph",
        "show attendance graph for class",
        "visualize attendance concerns",
        "chart poor attendance",
    ]),
    "class_risk_graph": _expand([
        "risk distribution graph",
        "high risk chart",
        "graph high risk students",
        "show risk chart",
        "visualize student risk",
    ]),
