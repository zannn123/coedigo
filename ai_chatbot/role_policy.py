...
ROLE_FALLBACKS = {
    "student": "I’m not sure yet. How may I help you today? You can ask about your schedule, grades, attendance, missing activities, or risk status.",
    "faculty": "I’m not sure yet. How may I help you today? You can ask for a class summary, high-risk students, attendance concerns, or missing activities.",
    "dean": "I’m not sure yet. How may I help you today? You can ask for a college summary, program risk summary, high-risk overview, or attendance overview.",
    "program_chair": "I’m not sure yet. How may I help you today? You can ask for a program summary, section summary, high-risk students, or subject concerns.",
    "admin": "I’m not sure yet. How may I help you today? You can ask for an overall summary, high-risk overview, attendance concerns, or missing activities.",
}
...
def canonicalize_intent_for_role(intent, role):
    ...
    if role == "faculty":
        return {
            ...
            "enrolled_subjects": "faculty_subject_students",
            "subjects": "faculty_subject_students",
        }.get(intent, intent)
